...
## ARCHIVE NOTE: THIS WAS ARCHIVED BECAUSE THIS SETS FISHING EFFORT ENDOGENOUSLY, BUT WE ARE MAKING A MODEL THAT PUTS EFFORT IN CELLS BASED ON EXPECTED CATCH (EXOGENOUS EFFORT)
